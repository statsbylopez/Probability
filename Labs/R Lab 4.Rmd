...
Today our lab will deal with Poisson variables and, eventually properties of independent variables
...
Let Z = aX + b, for any constant `a` and `b`. What is the expected value of Z? 
